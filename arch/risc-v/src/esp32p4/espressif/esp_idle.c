/****************************************************************************
 * arch/risc-v/src/esp32p4/espressif/esp_idle.c
 *
...
#ifdef CONFIG_PM
static spinlock_t g_esp_idle_lock = SP_UNLOCKED;
#endif
...
#  else
  ...
  if (newstate != oldstate)
    {
      flags = spin_lock_irqsave(&g_esp_idle_lock);
      ...
      spin_unlock_irqrestore(&g_esp_idle_lock, flags);
